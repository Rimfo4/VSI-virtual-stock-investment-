...
public abstract class Story extends JFrame{
    ...
    static String[] story = new String[14];
    {
        ...
        story[8] = "JM뉴스입니다.\n" +
                ...
                "강력한 성능의 노트북을 전량회수하기로 하였습니다. 이로인해 @@@기업과 ***기업의 계약을 끊고 결별하게됬습니다." +
                "다음 소식은 &&&기업이 한달간 판매한 $$$과자의 수익 전체를 어린이 재단에 기부한다고 합니다. " +
                "이러한 선행이 많았으면 좋겠네요.";
        //사성전자(17 ~ 21), 넷폴릭스(15 ~ 23) | 상승장 뉴스
        story[9] = "JM뉴스입니다.\n" +
                "@@@기업이 차세대 핸드폰인 세 번 접히는 핸드폰을 출시하였습니다. 이 핸드폰은 @@@기업의 다른 전자제품과 호환이" +
                "매우 잘되며 최신 프로세서를 탑제하여 전작과 비교불과 수준의 성능을 보여줍니다." +
        ...
        story[10] = "JM뉴스입니다.\n" +
                ...
                "***기업은 우주선 개발을 토대로 전세계의 인터넷을 띄워 인터넷 사용이 어려운 나라에서 사용하게끔 해주었습니다." +
    ...
    //시나리오 중복 체크
    static boolean[] stockCheckBoolean = new boolean[7];
